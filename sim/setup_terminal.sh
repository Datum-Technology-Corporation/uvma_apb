...
### DV ###
# Local
export DV_UVMA_APB_SRC_PATH=${PROJECT_DV_DIR}/uvma_apb/src
export DV_UVME_APB_ST_SRC_PATH=${PROJECT_DV_DIR}/uvme_apb_st/src
export DV_UVMT_APB_ST_SRC_PATH=${PROJECT_DV_DIR}/uvmt_apb_st/src
